...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <div className="bg-[#FBEBB5] w-full h-screen mt-3">
        <div className="mx-auto flex flex-col md:flex-row items-center justify-center h-full 2xl:w-[1500px] px-4">
          <div className="text-center md:text-left">
            ...
            <h1 className="text-[14px] md:text-[16px] underline">Shop now</h1>
          </div>
          {/* Image */}
      ...
      <div className="w-full h-auto px-4 py-8">
        <div className="mx-auto 2xl:w-[1500px]">
          ...
          <h1 className="text-[16px] underline text-center font-bold mt-8">Shop now</h1>
        </div>
      </div>
      ...
      <div className="w-full h-auto bg-[#FFF9E5] py-8">
        <div className="mx-auto flex flex-col lg:flex-row items-center justify-center gap-8 2xl:w-[1500px]">
          ...
          <div className="text-center lg:text-left">
            <h1 className="font-bold text-[20px] lg:text-[28px]">New Arrivals</h1>
            <h1 className="font-bold text-[28px] lg:text-[38px]">Asgaard sofa</h1>
            <button className="mt-4 px-8 py-4 bg-white border border-black text-[16px] rounded">
              Order Now
            </button>
          </div>
        </div>
      ...
      <div className="w-full h-[540px] relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-black">
          <h1 className="text-[24px] md:text-[36px] font-poppins font-extrabold">Our Instagram</h1>
          <p className="text-[14px] md:text-[16px] font-poppins">Follow our store on Instagram</p>
